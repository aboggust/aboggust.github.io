...
<div id='intro'>
  <div id='intro-headshot-wrapper' class='intro-column'>
    ...
    <div class='column intro-item' id='job-market'>
      <div id='job-market-tag-line'>
        <span class='highlight'>I am on job market!</span>
        <span>I am excited about tenure-track faculty positions and research scientist roles.</span>
      </div>
      <div class='statement-links'>
        {% for statement in site.data.statements %}
          <a class='button' href="{{statement.link}}">
            <span class='clickable'>{{statement.name}}</span>
          </a>
        {% endfor %}
      </div>
    </div>
  ...
  <div id='intro-text-wrapper' class='intro-column'>
    ...
    <div id='intro-text' class='intro-item'>
      <p>
      Hi, I'm Angie! I'm a PhD candidate at <a href="https://www.mit.edu/">MIT</a> <a href="https://www.csail.mit.edu/">CSAIL</a> advised by <a href="{{site.data.people['arvindsatya'].url}}">{{site.data.people['arvindsatya'].name}}</a> in the <a href='http://vis.mit.edu/'>Visualization Group</a>.
      My research focuses on improving <b>human-AI alignment</b> by designing interfaces that communicate model representations and methods to shift them toward people's expectations.
